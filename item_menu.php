<table>
	<tr>
		<td><input type="submit" value="Search" OnClick="location.href='item_search.php'"></td>
		<td><input type="submit" value="Item Template" OnClick="location.href='item_template.php'"></td>
		<td><input type="submit" value="Item Loot" OnClick="location.href='item_loot.php'"></td>
		<td><input type="submit" value="Disenchant Loot" OnClick="location.href='disenchant_loot.php'"></td>
