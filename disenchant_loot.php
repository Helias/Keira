...
<tr>
<br>
<td><input type="text" class="medium" id="loot_id" name="loot_id" value="<?php echo $_GET['loot_id']; ?>"><input type="button" class="little" OnClick="location.href='disenchant_loot.php?entry='+document.getElementById('loot_id').value;"></td>
...
<p align="right"><input type="submit" value="Show Disenchant Loot Script" OnClick="Scripts('disenchant_loot_template')"></p>