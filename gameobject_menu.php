...
<table>
	<tr>
		...
		<td><input type="submit" value="GO Script" OnClick="location.href='gameobject_script.php<?php get_entry(); ?>'"></td>
		<td><input type="submit" value="Involved in" OnClick="location.href='gameobject_involved_in.php'"></td>
	</tr>
</table>
<table><tr><td><input type="submit" value="" style="height:5px; width: 555px;"></td></tr></table>