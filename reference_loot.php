...
<?php
get_loot('reference_loot_template', 'other');
?>
</table>
<table>
<tr>
...
<tr>
<br>
<td><input type="text" class="medium" id="loot_id" name="loot_id" value="<?php echo $_GET['loot_id']; ?>"><input type="button" class="little" OnClick="location.href='reference_loot.php?entry='+document.getElementById('loot_id').value;"></td>
...
<p align="right"><input type="submit" value="Show Reference Loot Script" OnClick="Scripts('reference_loot_template')"></p>